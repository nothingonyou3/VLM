...
from Models.DINOL14NetText import DINOL14NetTextModel
from Models.VITBNetText import VITBNetTextModel
from Models.VITSNetText import VITSNetTextModel
data = "bach"
model = "UNI"
pl.seed_everything(0, workers=True)
num_workers = 30
device = "gpu" if torch.cuda.is_available() else "cpu"
models = {'ResNet': ResNetTextModel, 'UNI': UNINetTextModel, 'DINOL14': DINOL14NetTextModel, 'VITS': VITSNetTextModel, 'VITB': VITBNetTextModel}
output_name = model+'_'+data + '_text_s0_pretrained_textencoder'
Net = models[model]
print(output_name)
if data == "pcam":
    max_steps = 12500
...
trainer = pl.Trainer(
        ...
        accelerator=device,
        devices=1,
        logger=[TensorBoardLogger(output_base_dir, name=output_name), CSVLogger("logs", name=output_name)],
